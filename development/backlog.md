...
> noting the stage, or defer it to post-`v0.1.0`. Nothing discovered is ever silently dropped.
...
- Give every item an ID (`B-001`, `B-002`, …), the stage it was found in, a priority
  (`P1` blocker / `P2` should-fix-before-ship / `P3` nice-to-have / `later` post-v0.1.0), and a clear
  action.
